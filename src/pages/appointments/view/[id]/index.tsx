            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="User Appointment User Id Touser"
                    text={
                      <Link as={NextLink} href={`/users/view/${data?.user_appointment_user_idTouser?.id}`}>
                        {data?.user_appointment_user_idTouser?.email}
                      </Link>
                    }
                  />
                )}
                {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="User Appointment Medical Staff Id Touser"
                    text={
